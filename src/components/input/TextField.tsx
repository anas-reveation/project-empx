...
const defaultInputClasses =
  'mt-1.5 px-2.5 py-2 text-sm rounded-lg focus:border-blue-500 disabled:bg-gray-150 outline-none transition-all duration-300 border border-[#3b3c4e] bg-black text-white';
