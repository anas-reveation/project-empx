    ...
    <>
      ...
      >
        ...
        <div className="w-full h-full flex flex-col overflow-y-auto">
          <div className="w-full rounded-t-md bg-orange-500 py-2 px-3.5 text-white text-base font-normal tracking-wider">
            Connected Wallets
          </div>
          ...
          <div className="w-full bg-orange-500 py-2 px-3.5 mb-4 text-white text-base font-normal tracking-wider">
            Transfer History
          </div>
